...
summary(mod2)
vif(mod2)
## After refactoring all the variables that were related to each other we can see that Monthly charges is dependant on some of the other variables. We will remove those which are not significant and check whether we should add them or not.
